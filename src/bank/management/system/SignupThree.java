...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
        ...
        add(number);  
        JLabel acard= new JLabel("This is your 16 digit Card No:");
        acard.setFont(new Font("Railway",Font.BOLD,12));
        acard.setBounds(100,330,300,15);
        add(acard);
...
JLabel pin= new JLabel("Pin:");
        ...
        add(pnumber);   
        JLabel apin= new JLabel("Your 4 Digit Password:");
        apin.setFont(new Font("Railway",Font.BOLD,12));
        apin.setBounds(100,400,300,15);
        add(apin);
        ...
        add(c6);
        c7= new JCheckBox("I hereby declare  that above entered detials are correct to the best of my knowledge");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==submit){
            ...
            if(r1.isSelected()){
                accountType= "Savings Acccount";
            }else if(r2.isSelected()){
                accountType= "Fixed Deposit Acccount";
            }else if(r3.isSelected()){
                accountType= "Current Acccount";
            }else if(r4.isSelected()){
                accountType= "Reccuring Deposit Acccount";
            }
